...
# Also someone should update the libs/mqtt_remote_method_calls.py file on the robot too (at some point before tianxihe).
...
def main():
    ...
    # DONE: 5. Delete the line below (mqtt_client = None) then uncomment
    # the code below.  It creates a real mqtt client.
...
def left_mouse_click(event, mqtt_client):
    ...
    # DONE: 8. Help get everyone on your team running this program at the
    # same time.
