...
def main():
    ...
    rc3.on_red_down = lambda state: handle_red_up_3(state, dc)
    rc4.on_blue_up = lambda state: handle_red_up_4(state, dc)
    ...
    while dc.running:
        # DONE: 4. Call the .process() method on your channel 1
        # RemoteControl object, then review and run your code.
        ...
        #   Review the handle functions below to see how they draw to the
        # screen.  They are already finished.
        rc2.process()
        rc3.process()
        rc4.process()

        # DONE: 7. Call over a TA or instructor to sign your team's checkoff
