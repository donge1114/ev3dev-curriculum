...
def arm_calibration(arm_motor, touch_sensor):
    ...
    arm_motor.run_to_rel_pos(position_sp=-arm_revolutions_for_full_range*360, speed_sp=MAX_SPEED, stop_aciton=ev3.Motor.STOP_ACTION_BRAKE)
...
def arm_down(arm_motor):
    ...
    arm_motor.run_to_abs_pos(position_sp=-14.2*360, speed=MAX_SPEED, stop_action=ev3.Motor.STOP_ACTION_BRAKE)
