...
def main():
    ...
    while time_s != 0:
        ...
        distance = int(input("Enter a distance (inches): ")) * 90
...
# : 3.DONE
#  Add a beep after the drive motors stop (see code below).  Test your
# code to hear the beep AFTER movement.
#   ev3.Sound.beep().wait()

# : 4.DONE Instead of using the run_forever, time.sleep, stop pattern switch to
